...
object EffectAddPoints : Effect<NoCompileData>("add_points") {
    ...
    override fun onEnable(
        ...
        if(player.persistentDataContainer.has(key)){
            ...
            Debuger.debug("Ignoring point: $point $amount")
            return
        }
        Debuger.debug("effectAdd points: $point $amount")
    ...
    override fun onDisable(dispatcher: Dispatcher<*>, identifiers: Identifiers, holder: ProvidedHolder) {
        ...
        Debuger.debug("effectRemove points: "+addedPoint.point+" "+addedPoint.amount)
